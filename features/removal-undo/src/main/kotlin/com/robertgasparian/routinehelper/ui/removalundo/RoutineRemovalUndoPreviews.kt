...
@Composable
private fun RoutineRemovalUndoPhonePreview() {
    RoutineHelperTheme {
        RoutineRemovalUndoPreviewContent()
    }
}
...
@Composable
private fun RoutineRemovalUndoLandscapePreview() {
    RoutineHelperTheme {
        RoutineRemovalUndoPreviewContent()
    }
}
...
@Composable
private fun RoutineRemovalUndoTabletPreview() {
    RoutineHelperTheme {
        RoutineRemovalUndoPreviewContent()
    }
}
...
@Composable
private fun RoutineRemovalUndoFoldablePreview() {
    RoutineHelperTheme {
        RoutineRemovalUndoPreviewContent()
    }
}
...
@Composable
private fun RoutineRemovalUndoPreviewContent() {
