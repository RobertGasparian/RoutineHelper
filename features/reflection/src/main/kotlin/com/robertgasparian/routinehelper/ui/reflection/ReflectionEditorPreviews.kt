...
@Composable
private fun ReflectionEditorComponentPhonePreview() {
    ReflectionEditorPreviewContent()
}
...
@Composable
private fun ReflectionEditorComponentLandscapePreview() {
    ReflectionEditorPreviewContent()
}

@Preview(name = "Tablet", showBackground = true, widthDp = 800, heightDp = 1280)
@Composable
private fun ReflectionEditorComponentTabletPreview() {
    ReflectionEditorPreviewContent()
}

@Preview(name = "Foldable", showBackground = true, widthDp = 673, heightDp = 841)
@Composable
private fun ReflectionEditorComponentFoldablePreview() {
    ReflectionEditorPreviewContent()
}

@Composable
private fun ReflectionEditorPreviewContent() {
    RoutineHelperTheme {
